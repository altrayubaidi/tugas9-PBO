...
public class ModelPraktikum {
    ...
    public ModelPraktikum(){
        ...
        try {
            koneksi = DriverManager.getConnection("jdbc:mysql://localhost/praktikum?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "");
        } catch (Exception e) {
